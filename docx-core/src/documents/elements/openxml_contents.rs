...
mod tests{
  ...
  fn test_openxml_multi(){
    let sample_text = [r#"<w:p><w:r>(1)</w:r><w:r><w:rPr><w:vertAlign w:val="superscript" /></w:rPr><w:t>4</w:t></w:r><w:r><w:rPr><w:rFonts w:scii="Cambria Math" w:hAnsi="Combria Math" h:hint="eastAsia"></w:rPr><w:t>×</w:t></w:r></w:p>"#, r#"<w:p><w:r>(2)</w:r><w:r><w:rPr><w:vertAlign w:val="superscript" /></w:rPr><w:t>5</w:t></w:r><w:r><w:rPr><w:rFonts w:scii="Cambria Math" w:hAnsi="Combria Math" h:hint="eastAsia"></w:rPr><w:t>y</w:t></w:r></w:p>"#];
    let mut x = OpenXmlContents::new();
